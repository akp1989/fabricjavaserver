...
public class RipeController {
	...
	@PostMapping(value="readPartial",produces="text/plain")
	public String assetReadPartial(@RequestBody String requestBody) throws ContractException, TimeoutException, InterruptedException, IOException {
